...
/**
 * This is the item provider adpater for a {@link org.eclipse.cdt.interfacegenerator.interfacegenerator.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterfaceItemProvider
	extends AbstractCppDataTypeItemProvider
	implements
	...
	public List getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAssignedComponentsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InterfacegeneratorPackage.eINSTANCE.getInterface_Name(),
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}

	/**
	 * This adds a property descriptor for the Assigned Components feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAssignedComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_assignedComponents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_assignedComponents_feature", "_UI_Interface_type"),
				 InterfacegeneratorPackage.eINSTANCE.getInterface_AssignedComponents(),
				 true));
	}
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InterfacegeneratorPackage.eINSTANCE.getInterface_Operations());
			childrenFeatures.add(InterfacegeneratorPackage.eINSTANCE.getInterface_DerivedFrom());
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InterfacegeneratorPackage.eINSTANCE.getInterface_Operations(),
				 InterfacegeneratorFactory.eINSTANCE.createOperation()));

		newChildDescriptors.add
			(createChildParameter
				(InterfacegeneratorPackage.eINSTANCE.getInterface_DerivedFrom(),
				 InterfacegeneratorFactory.eINSTANCE.createDerivation()));
	}
